...
#
	parameters = { "mpPvrVersion": get_version() }
	...
	setup(name = "mp_pvr",
	      ...
	      long_description = """"mp_pvr" provides an interface to support external PVR servers.""",
	      author = "direct Netware Group et al.",
	      author_email = "web@direct-netware.de",
	      license = "GPLv2+",
	      url = "https://www.direct-netware.de/redirect?mp;pvr",
